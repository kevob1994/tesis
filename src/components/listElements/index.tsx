    ...
    <Row gutter={40}>
      {listItems.length > 0 ? (
        listItems.map((item, index) => (
          <Col  xs={24} sm={12} md={12} span={span} key={url + item.id}>
            <div className={`content-list `}>
              <div className='item-list'>
                <Row>
                  ...
                  <Col xs={24} sm={24} md={24} lg={17} xl={17} xxl={17} className="content-margin">
                    <Row className='info-course'>
                      <div className='content-top'>
                        ...
                        <div>
                          <MenuItem
                            textGoItem={textGoItem}
                            goItem={() => goItem(item.id.toString())}
